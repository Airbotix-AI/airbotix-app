...
// Only the CANVAS is immersive: its hub `/learn/create/image` keeps the nav, the
// same way `/learn/create/blocks` does (D-IS-28).
...
const AUTO_FULLSCREEN_ROUTES = ['/learn/blocks/', '/learn/create/image/canvas'];
