...
import { listShareRequests, type PendingShareRequest } from '@/pages/learn/playground/sharingApi';
...
export function PortalNavDrawer() {
  ...
  const shareRequests = useQuery<PendingShareRequest[]>({
