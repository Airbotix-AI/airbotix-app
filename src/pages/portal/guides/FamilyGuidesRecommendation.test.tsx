...
// guides matching the family's known city/state and the kids' ages, and
// renders NOTHING when the guides endpoint fails so the Dashboard never
// breaks over the catalogue.
