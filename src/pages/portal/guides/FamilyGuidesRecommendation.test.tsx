...
// renders up to 3 recommended guides with a "View all" link, prefers featured
// guides matching the kids' ages, and renders NOTHING when the guides endpoint
// fails so the Dashboard never breaks over the catalogue.
...
describe('FamilyGuidesRecommendation', () => {
  it('shows 3 recommendations preferring featured guides matching kid ages', async () => {
    ...
    // featured + age-matched first, then remaining featured, then newest plain.
    expect(headings).toContain('Guide featured-match');
