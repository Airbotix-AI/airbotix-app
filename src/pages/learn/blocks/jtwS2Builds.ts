...
export const JTW_S2_BAG_LINES = [
  'Take a kettle with you',
  'Set off with a scroll',
  'Bring a scarf and set out',
] as const;
...
export const JTW_S2_C1_P5_SIGN_TARGET: Block[] = [
  { op: 'when_tap' },
  { op: 'show' },
  { op: 'say', text: 'Five Elements Mountain' },
  { op: 'end' },
];
...
export const JTW_S2_C2_P5_WUKONG_TARGET: Block[] = [
  { op: 'when_tap' },
  { op: 'show' },
  { op: 'say', text: 'I am waiting for travelers heading west' },
  { op: 'hop', n: 1 },
  { op: 'end' },
];
...
export const JTW_S2_C2_P7_LINES = [
  "I'll see the way",
  "I'll remember the mountain",
  "let's go together",
] as const;
export const JTW_S2_C2_P7_ACTIONS = [
  { op: 'hop', n: 1 },
  { op: 'turn_right', n: 1 },
] as const;
...
export const JTW_S2_C3_P4_WUKONG_TARGET: Block[] = [
  { op: 'when_flag' },
  { op: 'move_right', n: 4 },
  { op: 'say', text: 'There are water patterns here' },
  { op: 'wait', n: 2 },
  { op: 'end' },
];
export const JTW_S2_C3_P4_STONE_TARGET: Block[] = [
  { op: 'when_bump' },
  { op: 'grow', n: 1 },
  { op: 'play_sound', n: 2, text: 'Chime' },
  { op: 'end' },
];
export const JTW_S2_C3_P5_HORSE_TARGET: Block[] = [
  { op: 'when_bump' },
  { op: 'show' },
  { op: 'say', text: "I'm willing to go with you" },
  { op: 'hop', n: 1 },
  { op: 'end' },
];
...
export const JTW_S2_C4_P4_WUKONG_TARGET: Block[] = [
  { op: 'when_tap' },
  { op: 'say', text: 'Please send a blue route card' },
  { op: 'send_message', n: JTW_S2_BLUE },
  { op: 'end' },
];
export const JTW_S2_C4_P4_BAJIE_TARGET: Block[] = [
  { op: 'when_message', n: JTW_S2_BLUE },
  { op: 'move_right', n: 3 },
  { op: 'say', text: 'Gather at the entrance of the village' },
  { op: 'end' },
];
export const JTW_S2_C4_P5_BAJIE_TARGET: Block[] = [
  ...JTW_S2_C4_P4_BAJIE_TARGET.slice(0, -1),
  { op: 'send_message', n: JTW_S2_YELLOW },
  { op: 'end' },
];
export const JTW_S2_C4_P5_HORSE_TARGET: Block[] = [
  { op: 'when_message', n: JTW_S2_YELLOW },
  { op: 'show' },
  { op: 'say', text: 'received' },
  { op: 'end' },
];
...
export const JTW_S2_C5_P4_WUJING_TARGET: Block[] = [
  { op: 'when_message', n: JTW_S2_YELLOW },
  { op: 'show' },
  { op: 'say', text: 'Shallow water mark here' },
  { op: 'end' },
];
export const JTW_S2_C5_P5_WUJING_TARGET: Block[] = [
  ...JTW_S2_C5_P4_WUJING_TARGET.slice(0, -1),
  { op: 'send_message', n: JTW_S2_PURPLE },
  { op: 'end' },
];
export const JTW_S2_C5_P5_WUKONG_REPLY: Block[] = [
  { op: 'when_message', n: JTW_S2_PURPLE },
  { op: 'hop', n: 1 },
  { op: 'say', text: 'The route is connected' },
  { op: 'end' },
];
export const JTW_S2_C6_P1_TARGET: Block[] = [
  { op: 'when_flag' },
  { op: 'say', text: 'The goal is far away, let’s go page by page' },
  { op: 'send_message', n: JTW_S2_BLUE },
  { op: 'goto_page', n: 2 },
];
export const JTW_S2_C6_P2_TARGET: Block[] = [
  { op: 'when_message', n: JTW_S2_BLUE },
  { op: 'move_right', n: 4 },
  { op: 'say', text: "I'll check the color first" },
  { op: 'send_message', n: JTW_S2_YELLOW },
  { op: 'goto_page', n: 3 },
];
export const JTW_S2_C6_WUJING_TARGET: Block[] = [
  { op: 'when_message', n: JTW_S2_YELLOW },
  { op: 'show' },
  { op: 'say', text: 'I caught the last part' },
  { op: 'end' },
];
...
export const JTW_S2_C6_WUKONG_TARGET: Block[] = [
  { op: 'when_tap' },
  { op: 'hop', n: 1 },
  { op: 'say', text: 'Four people and one horse, set off' },
  { op: 'end' },
];
...
export function isJtwS2C2P5TapCompletion(
  ...
  return (
    lessonId === JTW_S2_C2_P5_LESSON_ID &&
    characterId === JTW_S2_C2_WUKONG_ID &&
    goCompleted &&
    programMatches
  );
}
...
export function isJtwS2C2P7TapCompletion(
  ...
  return (
    lessonId === JTW_S2_C2_P7_LESSON_ID &&
    characterId === JTW_S2_C2_WUKONG_ID &&
    goCompleted &&
    programMatches
  );
...
function sameChain(actual: readonly Block[], expected: readonly Block[]): boolean {
  return (
    ...
    expected.every((block, index) => sameBlock(actual[index], block))
  );
}
...
function xuanzangFrame(
  ...
  if (!page || !person || page.background !== background || person.asset !== JTW_S2_ASSETS.xuanzang)
    return null;
  const start = person.start;
  return start.gx === XUANZANG_START.gx &&
    start.gy === XUANZANG_START.gy &&
    start.size === XUANZANG_START.size &&
    start.rot === XUANZANG_START.rot
    ? person
    : null;
}
...
function c3Frame(project: BlocksProject, lessonId: string): boolean {
  ...
  return Boolean(
    page?.id === `${lessonId}-page` &&
    page.background === C3_BACKGROUND &&
    page.characters.length === 3 &&
    wukong &&
    wukong.asset === JTW_S2_ASSETS.wukong &&
    wukong.start.gx === 2 &&
    wukong.start.gy === 8 &&
    stone &&
    stone.asset === JTW_S2_ASSETS.rippleStone &&
    stone.start.gy === 8 &&
    horse &&
    horse.asset === JTW_S2_ASSETS.horse &&
    horse.start.gx === 8 &&
    horse.start.gy === 8 &&
    horse.start.reach === 3 &&
    horse.start.visible === false,
  );
}
...
function messageActor(
  ...
  return (
    actor(project, `${lessonId}-page`, characterId)?.scripts.find(
...
function c6Chain(
  ...
  return (
    actor(project, `${lessonId}-page-${page}`, actorId)?.scripts.find(
      (script) => script.id === scriptId,
    )?.blocks ?? []
  );
}
...
function c6Frame(project: BlocksProject, lessonId: string): boolean {
  return (
    ...
    project.pages[0]?.id === `${lessonId}-page-1` &&
    project.pages[0]?.background === 'jtw-s2-c6-team-gather' &&
    project.pages[1]?.id === `${lessonId}-page-2` &&
    project.pages[1]?.background === 'jtw-s2-c6-team-bridge' &&
    project.pages[2]?.id === `${lessonId}-page-3` &&
    project.pages[2]?.background === 'jtw-s2-c6-team-west'
  );
}
...
export function jtwS2BuildMatches(project: BlocksProject, lessonId: string): boolean {
  ...
  if (lessonId === 'jtw-s2-c1-p4') {
    ...
    const blocks =
      person?.scripts.find((script) => script.id === 'xuanzang-departure')?.blocks ?? [];
    return Boolean(
      person && project.pages[0].characters.length === 1 && sameChain(blocks, JTW_S2_C1_P4_TARGET),
    );
  }
  ...
  if (lessonId === 'jtw-s2-c1-p5') {
    ...
    const signBlocks =
      sign?.scripts.find((script) => script.id === 'mountain-sign-tap')?.blocks ?? [];
    return Boolean(
      person &&
      sign &&
      page.characters.length === 2 &&
      sign.asset === JTW_S2_ASSETS.routeMarker &&
      sign.start.gx === 10 &&
      sign.start.gy === 8 &&
      sign.start.visible === false &&
      sameChain(route, JTW_S2_C1_P4_TARGET) &&
      sameChain(signBlocks, JTW_S2_C1_P5_SIGN_TARGET),
    );
  }
  ...
  if (lessonId === 'jtw-s2-c1-p6') {
    ...
    const blocks =
      person?.scripts.find((script) => script.id === 'xuanzang-departure-debug')?.blocks ?? [];
    return Boolean(
      person && project.pages[0].characters.length === 1 && sameChain(blocks, JTW_S2_C1_P6_TARGET),
    );
  }
  ...
  if (lessonId === 'jtw-s2-c1-p7') {
    ...
    const blocks =
      person?.scripts.find((script) => script.id === 'xuanzang-personal-departure')?.blocks ?? [];
    const bag = blocks[1];
    const pace = blocks[2];
    return Boolean(
      person &&
      project.name === 'My First Westward Departure' &&
      project.pages[0].characters.length === 1 &&
      blocks.length === 8 &&
      ...
      sameBlock(blocks[6], { op: 'say', text: 'Arrived at the foot of the mountain' }) &&
      blocks[7]?.op === 'end',
    );
  }
  ...
  if (lessonId === 'jtw-s2-c2-p4') {
    ...
    const blocks =
      person?.scripts.find((script) => script.id === 'xuanzang-approaches-mountain')?.blocks ?? [];
    ...
    return Boolean(
      ...
      page.characters.length === 2 &&
      wukong.asset === JTW_S2_ASSETS.wukong &&
      sameChain(blocks, JTW_S2_C2_P4_TARGET) &&
      sameChain(waiting, [{ op: 'when_tap' }, { op: 'end' }]),
    );
  }
  ...
  if (lessonId === JTW_S2_C2_P5_LESSON_ID) {
    ...
    return Boolean(
      ...
      wukong.start.size === 2 &&
      wukong.start.rot === 0 &&
      wukong.start.visible === false &&
      sameChain(approach, JTW_S2_C2_P4_TARGET) &&
      sameChain(answer, JTW_S2_C2_P5_WUKONG_TARGET),
    );
  }
  ...
  if (lessonId === JTW_S2_C2_P6_LESSON_ID) {
    ...
    const answer =
      wukong?.scripts.find((script) => script.id === 'wukong-answers-too-early')?.blocks ?? [];
    return Boolean(
      person &&
      wukong &&
      page.characters.length === 2 &&
  ...
  if (lessonId === JTW_S2_C2_P7_LESSON_ID) {
    ...
    const blocks =
      wukong?.scripts.find((script) => script.id === 'wukong-first-step')?.blocks ?? [];
    const line = blocks[2];
    ...
    return Boolean(
      ...
      sameChain(approach, JTW_S2_C2_P4_TARGET) &&
      blocks.length === 5 &&
      sameBlock(blocks[0], { op: 'when_tap' }) &&
      sameBlock(blocks[1], { op: 'show' }) &&
      line?.op === 'say' &&
      JTW_S2_C2_P7_LINES.includes((line.text ?? '') as (typeof JTW_S2_C2_P7_LINES)[number]) &&
      JTW_S2_C2_P7_ACTIONS.some((choice) => sameBlock(action, choice)) &&
      sameBlock(blocks[4], { op: 'end' }),
    );
  }
  ...
  if ([JTW_S2_C3_P4_LESSON_ID, JTW_S2_C3_P5_LESSON_ID, JTW_S2_C3_P6_LESSON_ID].includes(lessonId)) {
    ...
    const horse = c3Actor(project, lessonId, JTW_S2_C3_HORSE_ID);
    const route =
      wukong?.scripts.find((script) => script.id === 'wukong-stream-route')?.blocks ?? [];
    ...
    return (
      c3Frame(project, lessonId) &&
      stone?.start.gx === 6 &&
      sameChain(route, JTW_S2_C3_P4_WUKONG_TARGET) &&
      sameChain(ripple, JTW_S2_C3_P4_STONE_TARGET) &&
      (needsHorse
        ? sameChain(welcome, JTW_S2_C3_P5_HORSE_TARGET)
        : sameChain(welcome, [{ op: 'when_bump' }, { op: 'end' }]))
    );
  }
  ...
  if (lessonId === JTW_S2_C3_P7_LESSON_ID) {
    ...
    return (
      c3Frame(project, lessonId) &&
      [5, 6, 7].includes(stone.start.gx) &&
      distance === stone.start.gx - 2 &&
      [3, 4, 5].includes(distance) &&
      route.length === 5 &&
      route[0]?.op === 'when_flag' &&
      route[1]?.op === 'move_right' &&
      sameBlock(route[2], { op: 'say', text: 'There are water patterns here' }) &&
      sameBlock(route[3], { op: 'wait', n: 2 }) &&
  ...
  if (['jtw-s2-c4-p4', 'jtw-s2-c4-p5', 'jtw-s2-c4-p6', 'jtw-s2-c4-p7'].includes(lessonId)) {
    ...
    if (lessonId === 'jtw-s2-c4-p4') {
      return (
        sameChain(send, JTW_S2_C4_P4_WUKONG_TARGET) &&
    ...
    if (lessonId === 'jtw-s2-c4-p5' || lessonId === 'jtw-s2-c4-p6') {
      return (
        sameChain(send, JTW_S2_C4_P4_WUKONG_TARGET) &&
        sameChain(receive, JTW_S2_C4_P5_BAJIE_TARGET) &&
    ...
    return (
      JTW_S2_C4_P7_COLOURS.includes(colour as (typeof JTW_S2_C4_P7_COLOURS)[number]) &&
      get === colour &&
      (sameBlock(direction, { op: 'move_right', n: 3 }) ||
        sameBlock(direction, { op: 'move_left', n: 3 })) &&
      sameBlock(receive[2], { op: 'say', text: 'Gather at the entrance of the village' }) &&
      sameBlock(receive[3], { op: 'send_message', n: JTW_S2_YELLOW }) &&
      receive[4]?.op === 'end' &&
      sameChain(receipt, JTW_S2_C4_P5_HORSE_TARGET)
    );
  }
  ...
  if (['jtw-s2-c5-p4', 'jtw-s2-c5-p5', 'jtw-s2-c5-p6', 'jtw-s2-c5-p7'].includes(lessonId)) {
    ...
    if (lessonId === 'jtw-s2-c5-p4') {
      return (
        sameChain(send, JTW_S2_C5_P4_WUKONG_TARGET) &&
        sameChain(receive, JTW_S2_C5_P4_WUJING_TARGET)
      );
    }
    const reply =
      actor(project, `${lessonId}-page`, JTW_S2_C5_WUKONG_ID)?.scripts.find(
        (script) => script.id === 'wukong-relay-receipt',
      )?.blocks ?? [];
    if (lessonId === 'jtw-s2-c5-p5' || lessonId === 'jtw-s2-c5-p6') {
      return (
        sameChain(send, JTW_S2_C5_P4_WUKONG_TARGET) &&
        sameChain(receive, JTW_S2_C5_P5_WUJING_TARGET) &&
        sameChain(reply, JTW_S2_C5_P5_WUKONG_REPLY)
      );
    }
    ...
    return (
      [first, second, receipt].every((colour) => [2, 3, 4, 5, 6].includes(colour ?? -1)) &&
      new Set([first, second, receipt]).size === 3 &&
      relay[0]?.n === first &&
      receive[0]?.n === second &&
      reply[0]?.n === receipt &&
      send[0]?.op === 'when_tap' &&
  ...
  if (['jtw-s2-c6-p4', 'jtw-s2-c6-p5', 'jtw-s2-c6-p6', 'jtw-s2-c6-p7'].includes(lessonId)) {
    ...
    if (!sameChain(page1, JTW_S2_C6_P1_TARGET) || !sameChain(page2, JTW_S2_C6_P2_TARGET))
      return false;
    if (lessonId === 'jtw-s2-c6-p4') {
      return sameChain(wujing, [{ op: 'when_message', n: JTW_S2_YELLOW }, { op: 'end' }]);
    }
    if (!sameChain(wujing, JTW_S2_C6_WUJING_TARGET) || !sameChain(horse, JTW_S2_C6_HORSE_TARGET))
      return false;
    if (lessonId !== 'jtw-s2-c6-p7') return sameChain(wukong, JTW_S2_C6_WUKONG_TARGET);
    return (
      wukong.length === 4 &&
      wukong[0]?.op === 'when_tap' &&
      ['hop', 'grow'].includes(wukong[1]?.op ?? '') &&
      wukong[2]?.op === 'say' &&
      wukong[3]?.op === 'end'
    );
  }
