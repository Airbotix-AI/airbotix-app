...
describe('StoryJourneyMap', () => {
  it('shows the complete six-chapter story while distinguishing playable scenes from previews', () => {
    ...
    expect(screen.getAllByTestId(/blocks-starter-blocks_tsv_/)).toHaveLength(10);
    expect(screen.getByTestId('story-chapter-a3')).toHaveTextContent('2 scenes ready');
  ...
  it('keeps the story count derived from the playable mission catalogue', () => {
    ...
    expect(PLAYABLE_STORY_MISSION_COUNT).toBe(10);
