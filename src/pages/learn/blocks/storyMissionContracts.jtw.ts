...
export const JTW_MISSION_CONTRACTS: Record<string, StoryMissionProgramContract> = {
  ...
  'jtw-s2-c1-p6': {
    ...
    characterId: 'xuanzang', scriptId: 'xuanzang-departure-debug', asset: '',
  ...
  'jtw-s2-c1-p7': {
    ...
    characterId: 'xuanzang', scriptId: 'xuanzang-personal-departure', asset: '',
  ...
  'jtw-s2-c2-p4': {
    ...
    characterId: 'xuanzang', scriptId: 'xuanzang-approaches-mountain', asset: '',
  ...
  'jtw-s2-c2-p5': {
    ...
    characterId: 'wukong-waiting', scriptId: 'wukong-answers', asset: '',
  ...
  [JTW_S2_C2_P6_LESSON_ID]: {
    ...
    characterId: 'wukong-waiting', scriptId: 'wukong-answers-too-early', asset: '',
    start: { gx: 12, gy: 8, size: 2, rot: 0 }, characterCount: 2,
    allowedSayText: ['我等的是向西的旅人'], target: [...JTW_S2_C2_P5_WUKONG_TARGET],
  },
  [JTW_S2_C2_P7_LESSON_ID]: {
    pageId: 'jtw-s2-c2-p7-page', background: 'jtw-s2-c2-five-elements-mountain',
    characterId: 'wukong-waiting', scriptId: 'wukong-first-step', asset: '',
    start: { gx: 12, gy: 8, size: 2, rot: 0 }, characterCount: 2,
  ...
  [JTW_S2_C3_P4_LESSON_ID]: {
    ...
    characterId: 'wukong-scout', scriptId: 'wukong-stream-route', asset: '',
  ...
  [JTW_S2_C3_P5_LESSON_ID]: {
    ...
    characterId: 'white-dragon-horse', scriptId: 'horse-welcome', asset: '',
  ...
  'jtw-s2-c4-p4': {
    ...
    characterId: JTW_S2_C4_WUKONG_ID, scriptId: 'wukong-route-send', asset: '',
  ...
  'jtw-s2-c4-p5': {
    ...
    characterId: JTW_S2_C4_HORSE_ID, scriptId: 'horse-route-receipt', asset: '',
  ...
  'jtw-s2-c4-p6': {
    ...
    characterId: JTW_S2_C4_BAJIE_ID, scriptId: 'bajie-route-receive', asset: '',
  ...
  'jtw-s2-c5-p4': {
    ...
    characterId: JTW_S2_C5_WUKONG_ID, scriptId: 'wukong-relay-send', asset: '',
  ...
  'jtw-s2-c5-p5': {
    ...
    characterId: JTW_S2_C5_WUKONG_ID, scriptId: 'wukong-relay-receipt', asset: '',
    start: { gx: 2, gy: 7, size: 2, rot: 0 }, characterCount: 3,
  ...
  'jtw-s2-c6-p4': {
    ...
    characterId: 'xuanzang-team', scriptId: 'xuanzang-team-start', asset: '',
  ...
  'jtw-s2-c6-p5': {
    ...
    characterId: 'wujing-team', scriptId: 'wujing-team-finish', asset: '',
  ...
  'jtw-s2-c6-p6': {
    ...
    characterId: 'bajie-team', scriptId: 'bajie-team-bridge', asset: '',
  ...
  'jtw-s2-c6-p7': {
    ...
    characterId: 'wukong-team', scriptId: 'wukong-team-finish', asset: '',
