...
export const JTW_MISSION_CONTRACTS: Record<string, StoryMissionProgramContract> = {
  ...
  'jtw-s2-c1-p5': {
    ...
    allowedSayText: ['五行山'], target: [...JTW_S2_C1_P5_SIGN_TARGET],
  },
  'jtw-s2-c1-p6': {
    ...
    start: { gx: 2, gy: 9, size: 2, rot: 0 }, allowedSayText: ['行囊带好', '到了'],
  ...
  'jtw-s2-c1-p7': {
    ...
    start: { gx: 2, gy: 9, size: 2, rot: 0 }, allowedSayText: [...JTW_S2_BAG_LINES, '到了山下'],
  ...
  'jtw-s2-c2-p4': {
    ...
    allowedSayText: ['是谁在说话'], target: [...JTW_S2_C2_P4_TARGET],
  },
  'jtw-s2-c2-p5': {
    ...
    allowedSayText: ['我等的是向西的旅人'], target: [...JTW_S2_C2_P5_WUKONG_TARGET],
  },
  [JTW_S2_C2_P6_LESSON_ID]: {
  ...
  [JTW_S2_C3_P4_LESSON_ID]: {
    ...
    allowedSayText: ['这里有水纹'], target: [...JTW_S2_C3_P4_WUKONG_TARGET],
  },
  [JTW_S2_C3_P5_LESSON_ID]: {
    ...
    allowedSayText: ['我愿意同行'], target: [...JTW_S2_C3_P5_HORSE_TARGET],
  },
  [JTW_S2_C3_P6_LESSON_ID]: {
  ...
  'jtw-s2-c4-p4': {
    ...
    allowedSayText: ['请送蓝色路线卡'], target: [...JTW_S2_C4_P4_WUKONG_TARGET],
  },
  'jtw-s2-c4-p5': {
    ...
    allowedSayText: ['收到了'], target: [...JTW_S2_C4_P5_HORSE_TARGET],
  },
  'jtw-s2-c4-p6': {
    ...
    allowedSayText: ['村口集合'], target: [...JTW_S2_C4_P4_BAJIE_TARGET],
  },
  'jtw-s2-c4-p7': {
  ...
  'jtw-s2-c5-p5': {
    ...
    start: { gx: 2, gy: 7, size: 2, rot: 0 }, characterCount: 3,
    allowedSayText: ['路线接上了'], target: [...JTW_S2_C5_P5_WUKONG_REPLY],
  },
  'jtw-s2-c5-p6': {
  ...
  'jtw-s2-c6-p4': {
    ...
    allowedSayText: ['目标很远，我们一页一页走'], target: [...JTW_S2_C6_P1_TARGET],
  },
  'jtw-s2-c6-p5': {
    ...
    allowedSayText: ['最后一段，我接住了'], target: [...JTW_S2_C6_WUJING_TARGET],
  },
  'jtw-s2-c6-p6': {
    ...
    allowedSayText: ['我先核对颜色'], target: [...JTW_S2_C6_P2_TARGET],
  },
  'jtw-s2-c6-p7': {
    ...
    allowedSayText: ['四人一马，出发', '一起向西'], target: [{ op: 'when_tap' }, { op: 'end' }],
  },
  [JTW_C4_P7_LESSON_ID]: {
