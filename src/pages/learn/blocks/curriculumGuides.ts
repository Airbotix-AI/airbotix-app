...
const STORY_MISSIONS: Record<string, StoryMission> = {
  'jtw-s1-c1-p1': {
    mode: 'observe-only',
    lessonId: 'jtw-s1-c1-p1',
    celebrate: false,
    hero: {
      name: 'Stone Monkey',
      role: 'New friend inside the stone',
      asset: '/story-blocks/journey-to-the-west/characters/stone-monkey/neutral-v01.png',
    },
    eyebrow: 'Journey to the West · Chapter 1 · Part 1 of 8',
    title: 'Flower-Fruit Mountain wakes',
    storyPages: [],
    partnerLine: 'Look for evidence before the Stone Monkey appears.',
    mission: 'Find three clues, check the classic order, and predict who will appear.',
    question: 'Who will come from the stone, and what evidence supports your prediction?',
    choices: [],
    retry: 'Look again at the warm light, bright crack, and soft sound.',
    successTitle: 'The mountain is about to change',
    success: 'Your evidence shows that someone is ready to enter the world.',
    fixTitle: 'Read the clues',
    fixPrompt: 'Complete all three evidence steps.',
    workspaceIntro: 'The next Part program stays locked until the reading evidence is saved.',
    fixChoices: [],
    fixRetry: '',
    coach: {
      ready: 'Meet the Stone Monkey, then look closely at the mountain.',
      watch: 'Find the clues in the picture.',
      sayFirst: 'The Stone Monkey is still inside the stone.',
      sayThen: 'The Stone Monkey will appear in the next Part.',
      hopFirst: 'Do not run the next Part program yet.',
      hopThen: 'Your reading evidence comes first.',
      retry: 'Use the story and picture evidence.',
      fix: 'Check all three evidence steps.',
      test: 'Save the evidence before continuing.',
      saving: 'Saving your reading evidence…',
      complete: 'Part 1 is saved. Part 2 is unlocked.',
    },
    logicSteps: [],
    logicWhy: 'The reading evidence establishes the cause that the next Part program will show.',
    completionTitle: 'Part 1 complete',
    completion: 'You found the mountain clues, kept the classic order, and made a prediction with evidence.',
    completionSteps: [],
    completionWhy: 'The server saved all three evidence groups without running or changing the next Part program.',
    next: 'A soft thump comes from the stone. Next: listen to the stone.',
  },
  'tsv-s1-a1-h': {
    mode: 'observe-fix',
