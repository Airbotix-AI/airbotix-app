...
const VERSIONS: Array<{ id: JtwC4P5Version; label: string; template: `blocks_jtw_c4_p7_${JtwC4P5Version}` }> = [
  { id: 'hop', label: '跃过叶纹', template: 'blocks_jtw_c4_p7_hop' },
  { id: 'turn', label: '转身指家', template: 'blocks_jtw_c4_p7_turn' },
  { id: 'reappear', label: '屏风再现', template: 'blocks_jtw_c4_p7_reappear' },
];
