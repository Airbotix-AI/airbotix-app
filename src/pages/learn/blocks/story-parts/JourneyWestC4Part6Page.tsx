...
const VERSION_LABELS: Record<JtwC4P5Version, string> = { leaf: '跃过叶纹', home: '转身指家', screen: '屏风再现' };
...
export function JourneyWestC4Part6Page() {
  ...
  const selectedVersion = ((p5?.evidence as StoryPartEvidence | undefined)?.selections?.skill_version?.[0] ?? null) as JtwC4P5Version | null;
